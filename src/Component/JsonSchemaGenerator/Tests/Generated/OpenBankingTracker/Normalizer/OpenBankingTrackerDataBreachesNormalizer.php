...
class OpenBankingTrackerDataBreachesNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param OpenBankingTrackerDataBreaches $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof OpenBankingTrackerDataBreaches;
    }

    /**
     * @param array|object $data
     *
     * @return OpenBankingTrackerDataBreaches
     */
    public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var OpenBankingTrackerDataBreaches $output */
    ...
    {
        return $type === OpenBankingTrackerDataBreaches::class;
    }

    /** @return array<class-string, bool> */
    public function getSupportedTypes(?string $format): array
    {
        return [OpenBankingTrackerDataBreaches::class => true];
    }
}
